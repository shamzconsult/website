      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className='md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200'>
          ...
          <div className='text-sm text-gray-600 mr-4 flex flex-col gap-1 mt-8 lg:mt-0'>
            <p className=''>&copy; ShamzBridge. All rights reserved.</p>
            <p>
              <span className='text-orange-600'>Office address:</span> 4th
              Floor, Labour House, Central Business District, Abuja
            </p>
          </div>
        </div>
      </div>
