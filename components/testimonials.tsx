            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ One of the most impressive qualities of Shamz is their
                  genuine passion for making a difference. They go above and
                  beyond to ensure that our program not only meets but exceeds
                  expectations, constantly seeking feedback and implementing
